...
export function ChatBoxToRoomUrl(roomUrl) {
    return (
        window.location.href.split('/')[0] + "//" + window.location.href.split('/')[2] + `/appointments/meeting?roomUrl=${encodeURIComponent(roomUrl)}`
    );
}
